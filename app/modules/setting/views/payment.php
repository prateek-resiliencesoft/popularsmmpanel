          ...
          <div class="row">
            ...
            <div class="col-md-12 col-lg-12">
              ...
              <div class="form-group">
                ...
                <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("perfect_money")?></h5 class="text-info">
                <div class="form-group">
                    <div class="form-label"><?=lang("Status")?></div>
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-checkbox">
                            <input type="hidden" name="is_active_perfect_money" value="0">
                            <input type="checkbox" class="custom-control-input" name="is_active_perfect_money" value="1" <?=(get_option('is_active_perfectmoney', "") == 1)? "checked" : ''?>>
                            <span class="custom-control-label"><?=lang("Active")?></span>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="form-label"><?=lang("transaction_fee")?></label>
                    <select name="perfect_money_chagre_fee" class="form-control square">
                        <?php
                        for ($i = 0; $i <= 10; $i++) {
                            ?>
                            <option value="<?=$i?>" <?=(get_option("perfect_money_chagre_fee", 4) == $i)? "selected" : ''?>><?=$i?>%</option>
                        <?php } ?>
                    </select>
                </div>

                <div class="form-group">
                    <label class="form-label"><?=lang("perfect_money_account_id_usd")?></label>
                    <input class="form-control" name="perfect_money_account_id" value="<?=get_option('perfect_money_account_id',"")?>">
                </div>

                <div class="form-group">
                    <label class="form-label"><?=lang("perfect_money_account_name")?></label>
                    <input class="form-control" name="perfect_money_account_name" value="<?=get_option('perfect_money_account_name',"")?>">
                </div>
