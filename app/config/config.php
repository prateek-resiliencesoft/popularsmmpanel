...
if (stripos($_SERVER["REQUEST_URI"],'add_funds/payment_failed') !== FALSE ) {
    $config['csrf_protection'] 	= FALSE;
}

if (stripos($_SERVER["REQUEST_URI"],'add_funds/payment_success') !== FALSE ) {
    $config['csrf_protection'] 	= FALSE;
}
if (stripos($_SERVER["REQUEST_URI"],'add_funds/response') !== FALSE ) {
    $config['csrf_protection'] 	= FALSE;
}
